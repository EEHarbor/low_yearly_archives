<?php
/**
 * EEHarbor PHAR Loader for low_yearly_archives
 ...
 * @link       https://eeharbor.com/low_yearly_archives
 */

spl_autoload_register(
    function ($class_name) {
        // This is the PHAR path for this addon
        $phar_path = PATH_THIRD . 'low_yearly_archives/low_yearly_archives.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/low_yearly_archives';
